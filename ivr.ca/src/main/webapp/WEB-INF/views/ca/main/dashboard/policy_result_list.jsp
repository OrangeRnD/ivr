...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
						...
						<tr>
							...
							<td class="txt">${item.NOTIFTN_STDVAL} %</td>
							<c:choose><c:when test="${item.CMPR_CNT <= 0}">
							<td class="txt"> - </td>
							</c:when><c:otherwise>
							<td class="txt"><fmt:formatNumber value="${(item.OCCRRNC_CNT-item.CMPR_CNT)/item.CMPR_CNT*100}" pattern="#,##0.0"></fmt:formatNumber> %</td>
