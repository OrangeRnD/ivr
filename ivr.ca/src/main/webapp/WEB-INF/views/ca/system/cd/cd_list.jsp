...
<%@ taglib prefix="app" uri="/WEB-INF/tld/app.tld" %>
						...
						<tr>
							...
							<td class="txt"><a data-id="${item.USR_ID}">${item.EMP_NM}</a></td>
							<td class="txt">${item.EMP_NR}</td>
							<td class="txt">${app:phone(item.TELNO)}</td>
							...
							<td class="txt"><fmt:formatDate value="${item.LST_LGN_DT}" pattern="yyyy-MM-dd HH:mm"/></td>
