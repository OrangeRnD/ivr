		...
		<div class="tblBox">
			...
			<table class="tbltype01">
				...
				<tr id="first">
					<th>이름</th>
					<td>
						<input type="text" class="input01 wdt200px" name="empNm" title="이름" placeholder="이름" maxlength="25" required data-type="kor"/>
					</td>
					<th>직번</th>
					<td>
						<input type="text" class="input01 wdt200px" name="empNr" title="직번" placeholder="직번" maxlength="10" required data-type="eng"/>
					</td>
				</tr>
				<tr>
					<th>휴대전화</th>
					<td>
						<input type="text" class="input01 wdt200px" name="telno" title="휴대전화" placeholder="휴대전화" maxlength="15" data-type="tel"/>
					</td>
					<th>이메일</th>
					<td>
						<input type="text" class="input01 wdt200px" name="email" title="이메일" placeholder="이메일" maxlength="50" data-type="eng"/>
					</td>
				</tr>
				<tr>
					<th>알림수신</th>
		...
		<div class="tblBox">
			...
			<div>
				<table class="tblList">
					...
					<tbody id="lists">
						<tr><td colspan="11" class="txt">데이터 조회중입니다.</td></tr>
					</table>
			</div>
		</div>