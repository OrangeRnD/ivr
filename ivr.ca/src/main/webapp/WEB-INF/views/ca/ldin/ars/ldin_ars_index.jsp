...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
		<div class="titleBox">
			<p class="ltit">ARS 유형별 이용현황</p>
			<jsp:include page="../../../common/reload.jsp"></jsp:include>
		</div>
		<div class="tblBox">
			<form data-type="search" name="search_frm" data-url="/ldin/ars/list" data-target="tblList" data-search="true" data-append="false" data-session-type1="${sessionScope.session.param.ldin_ars.STANDARD}"  data-session-type2="${sessionScope.session.param.ldin_ars.COMPARE}">
			<table class="tbltype01">
				<colgroup><col width="11%"><col width="*"></colgroup>
				<tr id="first">
					<th>조회 기간</th>
					<td >
						<span class="calBox2"><input type="text" name="param[FROM_DT1]" class="inputCal" data-type="date" data-input="std_input" value="${sessionScope.session.param.ldin_ars.FROM_DT1}"><a data-type="calendar"><img src="${webappRoot}/resources/images/icon_calendar2.gif"></a></span> 
						<span class="wave">~</span> 
						<span class="calBox2"><input type="text" name="param[TO_DT1]" class="inputCal" data-type="date" data-input="std_input" value="${sessionScope.session.param.ldin_ars.TO_DT1}"><a data-type="calendar"><img src="${webappRoot}/resources/images/icon_calendar2.gif"></a></span> 
				...
				<tr>
					<th>비교 기간</th>
					<td>
						<span class="calBox2"><input type="text" name="param[FROM_DT2]" class="inputCal" data-type="date" data-input="compare_input" value="${sessionScope.session.param.ldin_ars.FROM_DT2}"><a data-type="calendar"><img src="${webappRoot}/resources/images/icon_calendar2.gif"></a></span> 
						<span class="wave">~</span> 
						<span class="calBox2"><input type="text" name="param[TO_DT2]" class="inputCal" data-type="date" data-input="compare_input" value="${sessionScope.session.param.ldin_ars.TO_DT2}"><a data-type="calendar"><img src="${webappRoot}/resources/images/icon_calendar2.gif"></a></span> 
				...
				<tr>
					<th>기준일</th>
					<td>
						<input id="RESTDE_ALTV" type="radio" name="param[RESTDE_ALTV]" value="-1"<c:if test="${sessionScope.session.param.ldin_ars.RESTDE_ALTV == null || sessionScope.session.param.ldin_ars.RESTDE_ALTV == '-1'}"> checked</c:if>><label for="RESTDE_ALTV"><span></span>전체</label>
						<input id="RESTDE_ALTV0" type="radio" name="param[RESTDE_ALTV]" value="0"<c:if test="${sessionScope.session.param.ldin_ars.RESTDE_ALTV == '0'}"> checked</c:if>><label for="RESTDE_ALTV0"><span></span>영업일만</label>
						<input id="RESTDE_ALTV1" type="radio" name="param[RESTDE_ALTV]" value="1"<c:if test="${sessionScope.session.param.ldin_ars.RESTDE_ALTV == '1'}"> checked</c:if>><label for="RESTDE_ALTV1"><span></span>휴일만</label>
					</td>
				</tr>
			</table>
			<div class="btnArea">
				...
				<a class="btntype02 btn_primary" id="btn_excel hide" data-url="/ldin/ars/excel">엑셀</a>
				</div>
			</div>
			</form>
		</div>
