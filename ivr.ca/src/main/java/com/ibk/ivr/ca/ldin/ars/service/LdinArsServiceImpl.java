package com.ibk.ivr.ca.ldin.ars.service;
...
import com.ibk.ivr.ca.ldin.ars.dao.LdinArsDAO;
 ...
 */
@Service
public class LdinArsServiceImpl implements LdinArsService {
	
    @Autowired
    private LdinArsDAO dao;
    
    public LdinArsServiceImpl() {
    }
    ...
    public Map<String, Object> selectMaxDtCallKnd(RequestVO vo) throws Exception {
    	return dao.selectMaxDtCallKnd(vo);
    }
