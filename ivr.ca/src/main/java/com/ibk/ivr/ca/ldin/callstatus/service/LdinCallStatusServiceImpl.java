...
import com.ibk.ivr.ca.ldin.callstatus.dao.LdinCallstatusDAO;
 ...
 */
@Service
public class LdinCallStatusServiceImpl implements LdinCallStatusService {
	
    @Autowired
    private LdinCallstatusDAO dao;
    
    public LdinCallStatusServiceImpl() {
    }
    ...
    public List<Map<String, Object>> selectListMedaCallStat(RequestVO vo) throws Exception {
    	return dao.selectListMedaCallStat(vo);
    }
    /**
     * IVR 현황
     *
    ...
    public List<Map<String, Object>> selectListUsrTypeInfo(RequestVO vo) throws Exception {
    	return dao.selectListUsrTypeInfo(vo);
    }
    ...
    public List<Map<String, Object>> selectListAgeRangeInfo(RequestVO vo) throws Exception {
    	return dao.selectListAgeRangeInfo(vo);
    }
}
