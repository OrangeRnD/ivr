...
import com.ibk.ivr.ca.ldin.status.dao.LdinStatusDAO;

/**
 * 실시간 텔레뱅킹 현황 service implements
 * 
 ...
 */
@Service
public class LdinStatusServiceImpl implements LdinStatusService {
	
    @Autowired
    private LdinStatusDAO dao;
    
    public LdinStatusServiceImpl() {
    }
    ...
    public List<Map<String, Object>> selectListLdinStat(RequestVO vo) throws Exception {
    	return dao.selectListLdinStat(vo);
    }
    ...
    public Map<String, Object> selectLstLdinStat(RequestVO vo) throws Exception {
    	return dao.selectLstLdinStat(vo);
    }
    ...
    public List<Map<String, Object>> selectListTrStat(RequestVO vo) throws Exception {
    	return dao.selectListTrStat(vo);
    }
    ...
    public List<Map<String, Object>> selectExcelMlyLdinStat(RequestVO vo) throws Exception {
    	return dao.selectExcelMlyLdinStat(vo);
    }
}
